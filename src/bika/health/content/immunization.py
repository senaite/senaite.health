    ...
    StringField(
        ...
        widget=ReferenceWidget(
            ...
            label=_("Immunization form",
                    "Type"),
            description=_(
                "Select a type of immunization. <br/>"
    ...
    TextField(
        ...
        widget=TextAreaWidget(
            ...
            description=_(
                ...
                "intermediate or low levels of infection.")
        ),
    ),
...
def getImmunizationForms(context):
    ...
    # the body, which causes the body itself to generate immunity against the
    # target. Vaccination is an active form of immunization. Passive
    # immunization is where pre-synthesized elements of the immune system are
    # transferred to a person so that the body does not need to produce these
    # elements itself. Currently, antibodies can be used for passive
    # immunization.
    types = [
