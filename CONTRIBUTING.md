# Contributing to senaite.health

Third-party contributions are essential for keeping `senaite.health` continuously 
improving. We simply cannot access the huge number of platforms and myriad 
configurations for running `senaite.health`. We want to keep it as easy as 
...
The following is a set of guidelines for contributing to senaite.health, which is 
...
bugs](https://github.com/senaite/senaite.health/issues)? Do you have a
suggestion for improvement? Then by all means please [submit a new
issue](https://github.com/senaite/senaite.health/issues/new), and do not
hesitate to comment on existing [open
issues](https://github.com/senaite/senaite.health/issues).
...
platform (Operating System and version, how did you installed senaite.health
...
The list of [open issues](https://github.com/senaite/senaite.health/issues)
...
### Preliminaries
   ...
   2. [Fork senaite.health from GitHub](
   https://github.com/senaite/senaite.health/fork). This will copy the whole
   `senaite.health` repository to your personal account.
   ...
   the actual username of your GitHub account):
          ...
          $ git clone https://github.com/YOUR_USERNAME/senaite.health

   4. Your forked repository https://github.com/YOUR_USERNAME/senaite.health will 
   receive the default name of `origin`. You can also add the original 
   `senaite.health` repository, which is usually called `upstream`:

          $ cd senaite.health
          $ git remote add upstream https://github.com/senaite/senaite.health.git
...
```
$ git remote -v
origin    https://github.com/YOUR_USERNAME/senaite.health.git (fetch)
origin    https://github.com/YOUR_USERNAME/senaite.health.git (push)
upstream  https://github.com/senaite/senaite.health.git (fetch)
upstream  https://github.com/senaite/senaite.health.git (push)
```
...
Alternatively, you can merge `senaite.health`'s `master` into your branch:
...
request](https://github.com/senaite/senaite.health/compare/). Head to your
 ...
 * Add a changelog entry in [CHANGES.rst](https://github.com/senaite/senaite.health/CHANGES.rst)
